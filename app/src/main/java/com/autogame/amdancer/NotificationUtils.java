...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.autogame.amdancer.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.autogame.amdancer.app";
